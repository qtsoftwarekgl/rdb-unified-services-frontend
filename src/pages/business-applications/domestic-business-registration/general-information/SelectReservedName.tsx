...
const SelectReservedName = () => {
  const { showSelectReservedName, setShowSelectReservedName, setCompanyName, handleSkip, reservedNames, handleSubmit, onSubmit, setValue, errors, clearErrors, selectedReservedName } = useReservedName();
