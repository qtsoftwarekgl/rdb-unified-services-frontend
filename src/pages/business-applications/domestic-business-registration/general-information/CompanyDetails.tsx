...
import {
  ...
  companyPositions,
  companyTypes,
  privateCompanyAbbreviations,
  privateCompanyTypes,
  publicCompanyAbbreviations
...
const CompanyDetails = ({
  ...
  const [companyTypesOptions, setBusinessTypesOptions] = useState<
    {
      label: string
      value: string
    }[]
  >()
  const [companyAbbreviations, setCompanyAbbreviations] = useState<
    {
      label: string
      value: string
    }[]
  ...
  useEffect(() => {
    if (watch("companyCategory") === "PUBLIC") {
      ...
      setCompanyAbbreviations(publicCompanyAbbreviations)
    } else if (watch("companyCategory") === "PRIVATE") {
      setBusinessTypesOptions(privateCompanyTypes)
      setCompanyAbbreviations(privateCompanyAbbreviations)
    }
          ...
          >
                  ...
                  return (
                    <label className="flex flex-col items-start w-full gap-1">
                      ...
                      >
                        {" "}
                        {`${
                          selectedReservedName ? "Change" : "Use"
                        } reserved name`}{" "}
                      </p>
            ...
            <menu className="flex items-start w-full gap-6">
              ...
              <Controller
                ...
                defaultValue={businessDetails?.abbreviation}
                render={({ field }) => {
                  return (
                    <label className="flex flex-col w-full gap-1">
                      <Select
                        ...
                        options={companyAbbreviations?.map((type) => {
                          return {
                            ...type,
                            value: type?.value,
                            label: type?.label
            ...
            <menu className="flex items-start w-2/4 gap-6 pr-3">
              <Controller
                control={control}
                name="position"
