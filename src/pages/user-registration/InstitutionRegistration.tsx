  ...
  return (
    <main className="flex flex-col gap-5 w-full">
      ...
      {!registrationSucess ? (
        ...
        <section className='flex flex-col gap-4 w-[60%] mx-auto bg-white p-6 rounded-md shadow-sm'>
          <h1 className='text-xl font-semibold text-center text-primary'>
            Registration successful
          </h1>
          <p className='text-center'>
            Your registration was successful. You will receive additional information on the email address provided.
          </p>
