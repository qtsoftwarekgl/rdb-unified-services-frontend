  ...
  return (
    <main className="flex flex-col gap-4 w-full">
      ...
      <section className="w-full h-full min-h-[85vh] flex flex-col items-center justify-center">
        <article className="bg-white w-[35%] rounded-md shadwow-sm flex flex-col gap-6 py-8 px-6 max-w-[600px] max-[1450px]:w-[40%] max-[1300px]:w-[45%] max-[1200px]:w-[50%] max-[1100px]:w-[55%] max-[900px]:w-[55%] max-[800px]:w-[60%] max-[700px]:w-[65%] max-[600px]:w-[70%] max-[550px]:w-[75%] max-[500px]:w-[80%] max-[450px]:w-[85%] max-[400px]:w-[90%] max-[350px]:w-[95%]">
          ...
          <FontAwesomeIcon className='text-[5rem] text-primary' icon={faCircleCheck} />
