...
import foreignCompanyRegistrationApiSlice from "./api/foreignCompanyRegistrationApiSlice";
...
export const store = configureStore({
  reducer: {
    ...
    [foreignCompanyRegistrationApiSlice.reducerPath]:
      foreignCompanyRegistrationApiSlice.reducer,
  ...
  middleware: (getDefaultMiddleware) => {
    return getDefaultMiddleware().concat(
      ...
      foreignCompanyRegistrationApiSlice.middleware,
